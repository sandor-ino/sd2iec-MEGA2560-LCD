...
/*
   Note that this file was changed for:
...
#define LCD_E_PIN        2            /**< pin  for Enable line     */
      ...
      defined(__AVR_ATmega161__) || defined(__AVR_ATmega162__) || defined(__AVR_ATmega2560__)
/*
...
#define LCD_FUNCTION_IS1      1      /*   DB1: instuction set select bit 1  */
#define LCD_FUNCTION_IS0      0      /*   DB0: instuction set select bit 0  */
...
/**
 @brief    check result of LCD controller auto detection

 added by andi6510
 @param    none
 @return   7: controller is a ST7036, 4/else: controller is not a ST7036
*/
extern uint8_t lcd_controller_type(void);
